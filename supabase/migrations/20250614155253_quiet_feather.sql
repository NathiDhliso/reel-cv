/*
  # Add Demo Data for ReelCV

  1. New Data
    - Demo skills for testing and development
    - Demo user accounts (candidate and proctor)
    - Pre-configured data for immediate testing

  2. Security
    - Uses proper password hashing for demo accounts
    - Maintains existing RLS policies
    - Safe insertion with existence checks
*/
